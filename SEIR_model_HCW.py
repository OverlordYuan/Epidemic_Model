...
import pandas as pd
from config.h_config import N,beta,alpha,gamma_1,gamma_2,I_0,E_0,R_0,S_0,T
...
# ax.legend(loc=0)
# ax.grid()
# ax.set_ylabel(r"湖北（除武汉）预计确诊人数（人）")
# ax2.set_ylabel(r"湖北（除武汉）预计新增确诊人数（人）")
# ax.set_xlabel("日期")
# # ax2.set_ylim(0, 100000)
# # ax.set_ylim(0,1000000)
# plt.title('湖北（除武汉）(EG)疫情感染人数预测')
# xticks=list(range(0,len(time),10)) # 这里设置的是x轴点的位置
